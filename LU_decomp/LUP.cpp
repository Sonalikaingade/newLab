...
void luDecomposition(vector<vector<int>> arr, vector<int> &voters){
    ...
    /*
        Initially AX = B was the equation. Now for simplicity we have breaked the equation into LUX = B, where A = LU.
        Let's consider UX = Y. Hence, LY = B. So first we will identify Y with the help of this equation.
    */
